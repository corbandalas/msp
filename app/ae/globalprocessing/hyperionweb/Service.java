 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://www.globalprocessing.ae/HyperionWeb", wsdlLocation = "https://ws-test.globalprocessing.ae:10000/hyperion_its/Service.asmx?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://www.globalprocessing.ae/HyperionWeb", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ws-test.globalprocessing.ae:10000/hyperion_its/Service.asmx?wsdl");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http://www.globalprocessing.ae/HyperionWeb", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.globalprocessing.ae/HyperionWeb", "ServiceSoap"), ServiceSoap.class, features);
    }
