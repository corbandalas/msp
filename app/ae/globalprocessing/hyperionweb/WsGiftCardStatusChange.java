...
@XmlRootElement(name = "Ws_GiftCard_StatusChange")
public class WsGiftCardStatusChange {
    ...
    @XmlElement(name = "NewStatCode")
    protected String newStatCode;
     ...
     *     
     */
    public void setNewStatCode(String value) {
