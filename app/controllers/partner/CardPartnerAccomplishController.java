...
//
    ...
    public F.Promise<Result> checkPassword() {
        ...
        F.Promise<Result> result = customerPromise.flatMap(customers -> accomplishService.validatePassword(customers.get().getReferral(), createCard.getPassword(), "" + authData.getAccount().getId())
                .map(res -> {
